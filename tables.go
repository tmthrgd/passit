...
var allowedRangeTable = &unicode.RangeTable{
	...
	R32: []unicode.Range32{
		...
		{Lo: 0x1145b, Hi: 0x1145f, Stride: 2},
		...
		{Lo: 0x119e1, Hi: 0x119e3, Stride: 1},
		...
		{Lo: 0x11fc0, Hi: 0x11ff1, Stride: 1},
		...
		{Lo: 0x16f50, Hi: 0x16fe2, Stride: 146},
		...
		{Lo: 0x1f110, Hi: 0x1f16c, Stride: 1},
		...
		{Lo: 0x1f400, Hi: 0x1f6d5, Stride: 1},
		{Lo: 0x1f6e0, Hi: 0x1f6ec, Stride: 1},
		{Lo: 0x1f6f0, Hi: 0x1f6fa, Stride: 1},
		...
		{Lo: 0x1f90d, Hi: 0x1f971, Stride: 1},
		{Lo: 0x1f973, Hi: 0x1f976, Stride: 1},
		{Lo: 0x1f97a, Hi: 0x1f9a2, Stride: 1},
		{Lo: 0x1f9a5, Hi: 0x1f9aa, Stride: 1},
		{Lo: 0x1f9ae, Hi: 0x1f9ca, Stride: 1},
		{Lo: 0x1f9cd, Hi: 0x1fa53, Stride: 1},
		{Lo: 0x1fa60, Hi: 0x1fa6d, Stride: 1},
		{Lo: 0x1fa70, Hi: 0x1fa73, Stride: 1},
		{Lo: 0x1fa78, Hi: 0x1fa7a, Stride: 1},
		{Lo: 0x1fa80, Hi: 0x1fa82, Stride: 1},
		{Lo: 0x1fa90, Hi: 0x1fa95, Stride: 1},
...
var allowedRangeTableStride1 = &unicode.RangeTable{
	...
	R32: []unicode.Range32{
		...
		{Lo: 0x1145f, Hi: 0x1145f, Stride: 1},
		{Lo: 0x11480, Hi: 0x114af, Stride: 1},
		{Lo: 0x114c4, Hi: 0x114c7, Stride: 1},
		{Lo: 0x114d0, Hi: 0x114d9, Stride: 1},
		{Lo: 0x11580, Hi: 0x115ae, Stride: 1},
		...
		{Lo: 0x116c0, Hi: 0x116c0, Stride: 1},
		{Lo: 0x116c1, Hi: 0x116c9, Stride: 1},
		{Lo: 0x11700, Hi: 0x1171a, Stride: 1},
		{Lo: 0x11730, Hi: 0x1173f, Stride: 1},
		{Lo: 0x11800, Hi: 0x1182b, Stride: 1},
		...
		{Lo: 0x119a0, Hi: 0x119a0, Stride: 1},
		{Lo: 0x119a1, Hi: 0x119a7, Stride: 1},
		{Lo: 0x119aa, Hi: 0x119d0, Stride: 1},
		{Lo: 0x119e1, Hi: 0x119e3, Stride: 1},
		{Lo: 0x11a00, Hi: 0x11a00, Stride: 1},
		{Lo: 0x11a0b, Hi: 0x11a0b, Stride: 1},
		{Lo: 0x11a0c, Hi: 0x11a32, Stride: 1},
		...
		{Lo: 0x16fe2, Hi: 0x16fe2, Stride: 1},
		{Lo: 0x17000, Hi: 0x187f7, Stride: 1},
		{Lo: 0x18800, Hi: 0x18af2, Stride: 1},
		{Lo: 0x1b000, Hi: 0x1b11e, Stride: 1},
		{Lo: 0x1b150, Hi: 0x1b152, Stride: 1},
		...
		{Lo: 0x1e800, Hi: 0x1e800, Stride: 1},
		{Lo: 0x1e801, Hi: 0x1e8c4, Stride: 1},
		{Lo: 0x1e8c7, Hi: 0x1e8cf, Stride: 1},
		{Lo: 0x1e900, Hi: 0x1e943, Stride: 1},
		{Lo: 0x1e950, Hi: 0x1e959, Stride: 1},
...
// Range entries: 896 16-bit, 657 32-bit, 1553 total.
// Range bytes: 5376 16-bit, 7884 32-bit, 13260 total.
// Emoji entries: 3019 total.
// Emoji bytes: 27198 total.
